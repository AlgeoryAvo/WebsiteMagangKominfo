...
<div class="main-content">
    <section class="section">
        ...
        <?php echo $this->session->flashdata('message'); ?>
            ...
            <i class="fas fa-minus fa-sm"></i> Ganti password</buttton>
                ...
                <table id="dataTables" class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tbody>
                            ...
                            <td>
                                <?php 
                                    if (empty($act->bukti_tagihan)) {
                                        echo '<center><img src="' . base_url('./assets/images/no-image.jpg') . '" border="0" width="70px" height="70px"> </center>';
                            ...
                            <td>
                            <?php echo anchor(
                                    'pptk/CPPTK/halamanInput/' . $act->id_kegiatan,
